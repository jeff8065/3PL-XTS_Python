...
#    		subprocess.Popen(sample, shell=True)
 #   	print sample
	...
	def selectToolVersion(self):
		...
		gmsversion = subprocess.check_output(
			str("adb -s " + self.serialListbox.get(i) + " shell getprop ro.com.google.gmsversion").split()).replace("\n","").strip().replace(" ", " ")
		global gmsversion
		self.mesListbox.insert(END,"SDK Version :" + sdk +"\n")
		self.mesListbox.insert(END,"GMS Version :" + gmsversion +"\n")
#		gmsversion = str(gmsversion.split(".")[2])
#		self.mesListbox.insert(END,"GO Version :" + gmsversion +"\n")
	...
	def CTS(self):
		self.versionListbox.delete(0, 15)	
		if sdk == "27": #8.1
			itemsforlistbox=['CTS-8.1_r18','CTS-8.1_r19']
		elif sdk == "29": #10.0
			itemsforlistbox=['CTS-10_r3','CTS-10_r4']
		elif sdk == "28": #9.0
			itemsforlistbox=['CTS-9.0_r11','CTS-9.0_r12']
		elif sdk == "26": #8.0
			itemsforlistbox=['CTS-8.0_r22','CTS-8.0_r23']
		elif sdk == "25": #7.1
	...
	def GTS(self):
		...
		if sdk == "22": #5.1
			...
			itemsforlistbox=['GTS-7.0r4- ','GTS-7.0r4-Local','GTS-7.0r5- ','GTS-7.0r5-Local',]
		self.versionListbox.delete(0, 15)
	...
	def VTS(self):
		self.versionListbox.delete(0, 15)	
		if sdk == "27": #8.1
			itemsforlistbox=['VTS-8.1_r11','VTS-8.1_r12']
		elif sdk == "28": #9.0
			itemsforlistbox=['VTS-9.0_r12','VTS-9.0_r13']
		elif sdk == "29": #10.0
			itemsforlistbox=['VTS-10_r3','VTS-10_r4']
		elif sdk == "26": #8.0
	...
	def GSI(self):
		self.versionListbox.delete(0, 15)	
		if sdk == "27": #8.1
			itemsforlistbox=['GSI-8.1_r11','GSI-8.1_r12']
		elif sdk == "28": #9.0
			itemsforlistbox=['GSI-9.0_r12','GSI-9.0_r13']
		elif sdk == "29": #10.0
			itemsforlistbox=['GSI-10_r3','GSI-10_r4']
		elif sdk == "26": #8.0
			itemsforlistbox=['GSI-8.0_r22','GSI-8.0_r23']
		for i in range (len(itemsforlistbox)):
			self.versionListbox.insert(i, itemsforlistbox[i])
	...
	#	itemsforlistbox=['STS- ']
		...
		sss = ss=str(gmsversion[-2])+str(gmsversion[-1])
		if sss =="go":
			itemsforlistbox=['STS- ','Goats- ']
		else :
			itemsforlistbox=['STS- '] 
		for i in range (len(itemsforlistbox)):
			self.versionListbox.insert(i, itemsforlistbox[i])
	def INSTANT(self):
		if sdk == "28": #9.0
			itemsforlistbox=['INSTANT-9.0_r11','INSTANT-9.0_r12']
		self.versionListbox.delete(0, 15)
		for i in range (len(itemsforlistbox)):
			self.versionListbox.insert(i, itemsforlistbox[i])
